...
SELECT dbo.FormatPhoneNumber ('+91-454512');
SELECT dbo.FormatPhoneNumber ('(91)-456465');
SELECT dbo.FormatPhoneNumber ('30023535');
SELECT dbo.FormatPhoneNumber ('8563112');
SELECT dbo.FormatPhoneNumber ('122422');